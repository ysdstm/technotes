...
for url in pagelinkfile.readlines():
    ...
    lessonno=urlarray[4]
    audiourl='http://openlanguage.com/lessons/'+lessonno+'/download-lesson-file?type=1&pass=643bdd49220861ecd5844bde0c19da52'
    r=requests.get(audiourl)
    with open(lessonno+'.'+lessonname+'.mp3','wb') as code:
